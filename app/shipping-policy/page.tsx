           ...
           <div className="w-full bg-[#F8F6F1] md:rounded-2xl rounded-none shadow-sm border border-neutral-200 p-6 sm:p-8 lg:p-10 space-y-6 text-neutral-800 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-3 space-y-1">
                <li>Standard Processing: 1–2 business days for order verification and packing.</li>
                <li>Pre-orders: Processing depends on product release date.</li>
                <li>Custom/Bulk Orders: 3–5 business days depending on size.</li>
                <li>Weekend Orders: Orders placed on Saturday/Sunday are processed next business day.</li>
              </ul>

              <p className="mt-3">
                You will receive an order confirmation email immediately after purchase,
                followed by a shipping confirmation with tracking details once dispatched.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                Note: Some remote pin codes may not be serviceable by our courier
                partners. We will notify you within 24 hours if delivery is unavailable.
              </p>
            </section>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
    ...
    <div className="bg-white border rounded-xl p-4 flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <div className="h-9 w-9 rounded-lg bg-red-50 flex items-center justify-center">
          <IconBuildingSkyscraper className="text-red-500" size={18} />
        </div>
    ...
    <div className="bg-white border rounded-xl p-4 flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <div className="h-9 w-9 rounded-lg bg-yellow-50 flex items-center justify-center">
          <IconBuildingEstate className="text-yellow-600" size={18} />
        </div>
    ...
    <div className="bg-white border rounded-xl p-4 flex flex-col gap-3">
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-black">Tier 3 Cities & Towns</h3>
      </div>
        ...
        10–14 Business Days
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-3 space-y-1">
                ...
                <li>Third Attempt: Final delivery attempt with notification.</li>
              </ul>
            ...
            <section>
              <h2 className="font-bold text-black">Packaging and Product Safety</h2>
              <ul className="list-disc pl-5 mt-3 space-y-1">
