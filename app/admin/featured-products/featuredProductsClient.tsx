...
const FeaturedProductsClient = ({ products, total, currentPage, pageSize }: Props) => {
  ...
  return (
    <div className="w-full p-1">
      <Card>
        <CardHeader>
          <CardTitle>Featured Product Listing</CardTitle>
          <CardDescription>View products currently marked as featured.</CardDescription>
        </CardHeader>
