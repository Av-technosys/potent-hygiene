...
const FeaturedCategoriesClient = ({ categories, total, currentPage, pageSize }: Props) => {
  ...
  return (
    <div className="w-full p-1">
      <Card>
        <CardHeader>
          <CardTitle>Featured Category Listing</CardTitle>
          <CardDescription>View categories currently marked as featured.</CardDescription>
        </CardHeader>
