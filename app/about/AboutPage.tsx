...
const AboutPage = () => {
  return (
    <section className="w-full bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 xl:px-8 py-12 xl:py-16 text-center">
  ...
  <p className="mt-5 text-sm sm:text-base text-gray-600 leading-relaxed max-w-7xl mx-auto">
    ...
    women to live confidently through every phase of their menstrual cycle.
        ...
        <section className="w-full bg-[#eaf1f8] py-12 sm:py-16 xl:py-20">
      <div className="container mx-auto px-4 sm:px-6 xl:px-8">
        <div className="grid grid-cols-1 xl:grid-cols-2 items-center gap-8 xl:gap-12">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <p className="text-gray-800 text-sm sm:text-base leading-relaxed">
              Through extensive research, collaboration with dermatologists,
              and feedback from real users, we developed a range of products
              that are safe, effective, and sustainable.
            </p>
